    ...
    return (
        ...
        <div className="py-16">
            <div className="flex bg-white rounded-lg  overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
                ...
                >
                    <img className='bg-indigo-100 h-[500px] w-[880px] object-cover' src="https://www.artbikashkendra.com/admin/assets/images/login.gif" alt="" />
                </div>
                <div className="w-full p-8 lg:w-1/2">
                    <h2 className="text-2xl font-semibold text-gray-700 text-center">Please Log in</h2>
                    <p className="text-xl text-gray-600 text-center">Hey,Welcome back!</p>
