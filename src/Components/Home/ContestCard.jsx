...
const ContestCard = ({data}) => {
    ...
    const {title,_id,startDate,prizes,participants,image,endDate,description,author_name,author_image,price}=data
    return (
  ...
  <div className="p-6">
    ...
    <h5 className="block font-sans text-xl font-medium leading-snug tracking-normal text-blue-gray-900 antialiased">
      ...
      Participants: <span className='text-red-500'>{participants}</span>
      </h5>
    </div>
