...
const ContestDetails = () => {
    ...
    console.log(data);
    const {title,_id,startDate,prizes,participants,ending,image,endDate,description,author_name,author_image,price}=data;
    return (
        <div>
  ...
  <div  className=" lg:ml-12 lg:mr-12 md:ml-12 md:mr-12 py-24 mx-auto">
    <div  className="lg:w-[100%]  mx-auto flex flex-wrap">
      <img alt="ecommerce"  className="lg:w-1/2 md:w-[600px] md:h-[600px] sm:w-[800px] mt-8 object-cover object-center rounded border border-gray-200" src={image}/>
      <div  className="lg:w-1/2 w-full lg:pl-10 md:pl-10 pl-3 pr-3 lg:py-6 mt-6 lg:mt-0">
        ...
        <div className=" flex gap-3 items-center font-semibold text-gray-800  hover:bg-gray-100 rounded-md hover:cursor-pointer">
           <div>
                <img className="w-10 h-10 rounded-full" src={author_image} alt="Rebecca Burke"/>
              </div>
        ...
        <div  className="flex mt-6 items-center pb-5 border-b-2 border-gray-200 mb-5">
          ...
          <div className='font-semibold text-xl -ml-6 flex gap-2'>
        <h1>Ending Date:</h1>
  <Countdown className='text-xl text-red-500' date={Date.now() + ending}>
        ...
        <div className='flex'>
         ...
         <Link to={`/details/${_id}`}>
         <button   className="flex ml-auto text-white bg-red-500 border-0 py-2 px-6 focus:outline-none hover:bg-red-600 rounded">Payment Now</button>
